...
import com.udea.webconcesionaire.entity.util.JsfUtil;
import com.udea.webconcesionaire.entity.util.PaginationHelper;
...
public class SaleController implements Serializable {
    ...
    @EJB
    private com.udea.webconcesionaire.entity.SaleFacade ejbFacade;
    ...
    public Sale getSale(java.lang.Long id) {
    ...
    public static class SaleControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sale) {
                Sale o = (Sale) object;
                return getStringKey(o.getSale_id());
            } else {
